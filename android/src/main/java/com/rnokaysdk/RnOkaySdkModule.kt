...
import com.rnokaysdk.logger.OkayRNExceptionLogger
import com.rnokaysdk.resourceprovider.OkayResourceProvider
import com.rnokaysdk.storage.SpaStorageImpl
import com.rnokaysdk.utils.getBooleanOrNull
import com.rnokaysdk.utils.getIntOrNull
import org.json.JSONObject
import timber.log.Timber


class RnOkaySdkModule(reactContext: ReactApplicationContext) :
...
//    val buttonBackgroundColor: String? = map["buttonBackgroundColor"]
    val screenBackgroundColor: String? =
      pageThemeMap?.getString("screenBackgroundColor") ?: "#ffffff"
...
//    val sessionTimerTextColor: String? = map["sessionTimerTextColor"]
  ...
  fun startPINLogin(data: ReadableMap, promise: Promise) {
    ...
    PsaManager.getInstance().startPinLogin(
